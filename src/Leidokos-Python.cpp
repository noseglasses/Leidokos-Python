...
unsigned long millis(void) {
   return leidokos::python::API::getMillis();
}
...
void 
   ...
   auto &finalizationCallbacks 
      = leidokos::python::pluginFinalizationCallbacks();
...
BOOST_PYTHON_MODULE(LEIDOKOS_PYTHON_PACKAGE_NAME)
{
   ...
   auto &registrationCallbacks 
      = leidokos::python::pluginRegistrationCallbacks();
   ...
   #define EXPORT_STATIC_METHOD(NAME, DOCSTRING) \
      boost::python::def(#NAME, &leidokos::python::API::NAME, DOCSTRING);
   ...
   boost::python::def("getVersionString", &leidokos::python::getVersionString,
   ...
   boost::python::def("getKeyDescription", &leidokos::key_description,
